...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "admin.sidebar.allApplications": "All Applications",
    ...
    "admin.supportTickets.open": "Open",
    "admin.supportTickets.inProgress": "In Progress",
    ...
    "admin.supportTickets.statuses.open": "Open",
    "admin.supportTickets.statuses.in-progress": "In Progress",
    ...
    "admin.settings.generalDescription":
      "Configure system preferences and basic settings",
    ...
    "client.applications.submitDescription":
      "Fill in the details below to submit a new application",
    ...
    "client.applications.noApplicationsMessage":
  ...
  ar: {
    ...
    "admin.supportChat.description":
      "نظام دعم العملاء المتقدم مع المراسلة في الوقت الفعلي وإدارة التذاكر وأدوات التعاون الجماعي.",
    "admin.settings.email.description":
      "تكوين إعدادات البريد الإلكتروني لنظام إدارة علاقات العملاء",
  ...
  "admin.supportTickets.description": "Manage all support tickets and their statuses | إدارة جميع تذاكر الدعم وحالاتها",
  "admin.supportTickets.newTicket": "New Ticket | تذكرة جديدة",
  "admin.supportTickets.createDescription": "Create a new support ticket for a client | إنشاء تذكرة دعم جديدة للعميل",
  ...
  "admin.supportTickets.describeIssue": "Describe the issue in detail | اشرح المشكلة بالتفصيل",
  ...
  "admin.supportTickets.selectAssignee": "Select assignee (optional) | اختر المسند إليه (اختياري)",
  ...
  "admin.supportTickets.open": "Open | مفتوحة",
  "admin.supportTickets.inProgress": "In Progress | قيد التنفيذ",
  "admin.supportTickets.resolved": "Resolved | تم الحل",
  "admin.supportTickets.searchPlaceholder": "Search tickets... | ابحث عن تذاكر...",
  "admin.supportTickets.noResults": "No tickets found matching your search. | لم يتم العثور على تذاكر تطابق بحثك.",
  "admin.supportTickets.noTickets": "No tickets found | لم يتم العثور على تذاكر",
  "admin.supportTickets.ticket": "Ticket | التذكرة",
  "admin.supportTickets.status": "Status | الحالة",
  "admin.supportTickets.statuses.open": "Open | مفتوحة",
  "admin.supportTickets.statuses.in-progress": "In Progress | قيد التنفيذ",
  ...
  "admin.supportTickets.updateTicket": "Update ticket details and status | تحديث تفاصيل التذكرة والحالة",
  "admin.supportTickets.clientCannotChange": "Client cannot be changed after ticket creation | لا يمكن تغيير العميل بعد إنشاء التذكرة",
  "admin.supportTickets.deleteTicket": "Delete Ticket | حذف التذكرة",
  "admin.supportTickets.deletePermanent": "This action cannot be undone. This will permanently delete the ticket and all associated data. | لا يمكن التراجع عن هذا الإجراء. سيتم حذف التذكرة وجميع البيانات المرتبطة بها بشكل دائم.",
  ...
  "admin.supportTickets.showingAll": "Showing all | عرض الكل",
    ...
    "admin.settings.generalDescription":
      "تكوين تفضيلات النظام والإعدادات الأساسية",
    "admin.settings.emailDesc":
      "تكوين إعدادات البريد الإلكتروني SMTP و IMAP و POP3",
    ...
    "client.applications.submitDescription":
      "املأ التفاصيل أدناه لإرسال طلب جديد",
