...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "auth.userNotFound": "This email is not registered",
    "auth.incorrectPassword": "Incorrect username or password",
    "auth.accountInactive": "Account is inactive. Contact an administrator.",
    "auth.createClientAccount": "Create Client Account",
    "auth.startJourney": "Start your company formation journey with us",
    "auth.fullName": "Full Name",
    "auth.fullNameEn": "Full Name (English)",
    "auth.fullNameAr": "Name in Arabic",
    "auth.fullNameArRequired": "Arabic Name is required.",
    "auth.fullNameEnPlaceholder": "e.g. John Doe",
    "auth.fullNameArPlaceholder": "مثال: جون دو",
    ...
    "auth.checkYourEmailDescription": "We sent a verification link to",
    "auth.checkSpamFolder": "Didn't get the email? Check your spam folder, or resend the verification link.",
    "auth.resendVerificationEmail": "Resend verification email",
    "auth.resending": "Sending...",
    "auth.verificationEmailResent": "Verification email sent. Please check your inbox.",
    "auth.resendVerificationFailed": "Failed to resend verification email.",
    "auth.emailRequiredForResend": "Email address is required to resend verification.",
    "auth.goToLogin": "Go to Login",
    "auth.emailNotVerified": "Please verify your email before signing in. Check your inbox for the verification link.",
    "auth.verifyingEmail": "Verifying email...",
    "auth.emailVerified": "Email verified",
    "auth.emailVerifiedSuccess": "Your email has been verified. You can now sign in.",
    "auth.verificationFailed": "Email verification failed.",
    ...
    "admin.sidebar.servicesCatalog": "Services Catalog",
    ...
    "admin.sidebar.paymentGateway": "Payment Gateway",
    "admin.sidebar.aiChatbot": "AI Chatbot",
    "admin.sidebar.databaseConnection": "Database Connection",
    "admin.sidebar.notificationEvents": "Notification Events",
    "admin.sidebar.backupRestore": "Backup & Restore",
    "admin.sidebar.audit": "Audit",
    "admin.sidebar.auditLogs": "Audit Logs",
    "admin.sidebar.userActivity": "User Activity",
    ...
    "admin.applications.card.total": "Total",
    "admin.applications.card.stepApprovalPending": "Step approval pending",
    "admin.applications.card.submittedPending": "Submitted pending",
    "admin.applications.card.clientInProgress": "Client in progress",
    "admin.applications.heading": "Applications",
    "admin.applications.headingSub": "Review drafts, submissions, and step approvals.",
    "admin.applications.startForClient": "Start Application for Client",
    "admin.applications.noMatch": "No applications match your search.",
    "admin.applications.noApplicationsYet": "No wizard applications yet.",
    "admin.applications.table.client": "Client",
    "admin.applications.table.application": "Application",
    "admin.applications.table.service": "Service",
    "admin.applications.table.steps": "Steps",
    "admin.applications.table.status": "Status",
    "admin.applications.table.stepApproval": "Step approval",
    "admin.applications.table.updated": "Updated",
    "admin.applications.table.actions": "Actions",
    "admin.applications.status.all": "All statuses",
    "admin.applications.status.inProgress": "In progress",
    "admin.applications.status.pending": "Pending",
    "admin.applications.status.underReview": "Under review",
    "admin.applications.status.hardCopyRequired": "Hard copy required",
    ...
    "admin.settings.general.clientNotifications": "Client Notifications",
    "admin.settings.general.clientNotificationsDesc": "Turn client application status notifications on or off. Email and WhatsApp are controlled separately.",
    "admin.settings.general.emailNotifications": "Email notifications",
    "admin.settings.general.emailNotificationsDesc": "When off, application status emails are not sent to clients.",
    "admin.settings.general.whatsappNotifications": "WhatsApp notifications",
    "admin.settings.general.whatsappNotificationsDesc": "When off, application status WhatsApp messages are not sent to clients.",
    "admin.settings.general.saved": "Client notification settings saved.",
    ...
    "client.sidebar.myInvoices": "My Invoices",
    ...
    "client.collaboration.addDescription": "Send an invite by email. Optional WhatsApp if you provide a phone number.",
    "client.collaboration.sendInvite": "Send invite",
    "client.collaboration.whatsappOptional": "WhatsApp phone (optional)",
    "client.collaboration.listTitle": "Collaborators & invites",
    "client.collaboration.empty": "No collaborators yet. Invite someone to get started.",
    "client.collaboration.status": "Status",
    "client.collaboration.invitedAt": "Invited",
    "client.collaboration.actions": "Actions",
    "client.collaboration.oneClientNote": "A collaborator can only be linked to one client account. They can start and fill applications on your behalf after accepting the invite.",
    "client.collaboration.loadFailed": "Could not load collaborators",
    "client.collaboration.inviteSent": "Invite sent",
    "client.collaboration.inviteSentDesc": "The collaborator will receive an email with an accept link.",
    "client.collaboration.inviteCreated": "Invite saved",
    "client.collaboration.emailSendFailed": "Invite was created but the email could not be sent. Check email settings and resend.",
    "client.collaboration.inviteFailed": "Invite failed",
    "client.collaboration.inviteResent": "Invite resent",
    "client.collaboration.resendFailed": "Resend failed",
    ...
    "client.applications.pageTitle": "Applications",
    "client.applications.pageDescription": "Start a new application or track ones you already applied",
    "client.applications.newTab": "New application",
    "client.applications.appliedTab": "Applied applications",
    "client.applications.newCardTitle": "Start a new application",
    "client.applications.newCardDescription": "Choose your area of interest — we'll open the active application wizard for that service right away.",
    "client.applications.draftBadge": "Draft in progress",
    "client.applications.continueDraft": "Continue draft",
    "client.applications.loading": "Loading…",
    "client.applications.noResults": "No results found",
    "client.applications.noApplicationsYet": "No applications yet",
    "client.applications.applicationCountSingular": "application",
    "client.applications.applicationCountPlural": "applications",
    "client.applications.foundSuffix": "found",
    "client.applications.trackStatus": "Track status and continue drafts anytime.",
    "client.applications.searchPlaceholder": "Search applications…",
    "client.applications.emptyStateMessage": "No applications yet. Start one from the New application tab.",
    "client.applications.startNewApplication": "Start new application",
    "client.applications.noSearchResults": "No applications match your search.",
    "client.applications.continueApplication": "Continue application",
    "client.applications.viewApplication": "View application",
    "client.applications.previousPage": "Previous page",
    "client.applications.nextPage": "Next page",
    "client.applications.pageLabel": "Page {page}",
    "client.applications.status.draft": "Draft",
    "client.applications.status.pending": "Pending",
    "client.applications.status.inProgress": "In progress",
    "client.applications.status.hardCopyRequired": "Hard copy required",
    "client.applications.status.approved": "Approved",
    "client.applications.status.rejected": "Rejected",
    "client.applications.status.completed": "Completed",
    "client.applications.table.application": "Application",
    "client.applications.table.area": "Area",
    "client.applications.table.progress": "Progress",
    "client.applications.table.status": "Status",
    "client.applications.table.adminUpdate": "Admin update",
    "client.applications.table.updated": "Updated",
    "client.applications.table.actions": "Actions",
    "client.applications.table.stepSingular": "step",
    "client.applications.table.stepPlural": "steps",
    "client.applications.table.pageOf": "Page {page} of {totalPages}",
    "client.applications.table.record": "record",
    "client.applications.table.records": "records",
    "client.applications.area.cr.label": "Company Registration (CR)",
    "client.applications.area.cr.description": "Set up an LLC in Saudi Arabia",
    "client.applications.area.pr.label": "Private Registration (PR)",
    "client.applications.area.pr.description": "Investor, talent, entrepreneur & more",
    "admin.wizards.title": "Create Application",
    "admin.wizards.heading": "Application wizards",
    "admin.wizards.description": "One live wizard per service — CR and PR can each have their own active form.",
    "admin.wizards.loading": "Loading…",
    "admin.wizards.noResults": "No results found",
    "admin.wizards.noWizards": "No wizards yet",
    "admin.wizards.foundSuffix": "found",
    "admin.wizards.searchPlaceholder": "Search wizards…",
    "admin.wizards.createFirst": "Create your first application steps wizard.",
    "admin.wizards.createButton": "Create Application",
    "admin.wizards.createStepsButton": "Create Applications Steps",
    "admin.wizards.noMatch": "No wizards match your search.",
    "admin.wizards.table.name": "Name",
    "admin.wizards.table.service": "Service",
    "admin.wizards.table.steps": "Steps",
    "admin.wizards.table.status": "Status",
    "admin.wizards.table.created": "Created",
    "admin.wizards.table.actions": "Actions",
    "admin.wizards.live": "Live",
    "admin.wizards.active": "Active",
    "admin.wizards.inactive": "Inactive",
    "admin.wizards.editLabel": "Edit wizard",
    "admin.wizards.deleteLabel": "Delete wizard",
    "admin.wizards.previewLabel": "Preview wizard",
    "admin.wizards.stepSingular": "step",
    "admin.wizards.stepPlural": "steps",
    "admin.wizards.recordSingular": "record",
    "admin.wizards.recordPlural": "records",
    "admin.wizards.pageOf": "Page {page} of {totalPages}",
    "admin.wizards.previousPage": "Previous page",
    "admin.wizards.nextPage": "Next page",
    "admin.wizards.pageLabel": "Page {page}",
    "admin.wizards.dialog.switchTitle": "Switch live wizard?",
    "admin.wizards.dialog.switchDesc": "Only one wizard can be live for clients at a time (CR or PR). Activating",
    "admin.wizards.dialog.willDeactivate": "will deactivate",
    "admin.wizards.dialog.cancel": "Cancel",
    "admin.wizards.dialog.activate": "Activate wizard",
    "admin.wizards.dialog.activating": "Activating…",
    "admin.wizards.dialog.deleteTitle": "Delete wizard?",
    "admin.wizards.dialog.deleteDesc": "This will remove",
    "admin.wizards.dialog.cannotUndo": "This cannot be undone.",
    "admin.wizards.dialog.delete": "Delete",
    "admin.wizards.dialog.deleting": "Deleting…",
    "admin.wizards.toast.deleted": "Wizard deleted",
    "admin.wizards.toast.deletedDesc": "removed.",
    "admin.wizards.toast.deleteFailed": "Delete failed",
    "admin.wizards.toast.couldNotDelete": "Could not delete wizard.",
    "admin.wizards.toast.activated": "Wizard activated",
    "admin.wizards.toast.activatedDesc": "is now live for",
    "admin.wizards.toast.othersDeactivated": "Other",
    "admin.wizards.toast.deactivated": "Wizard deactivated",
    "admin.wizards.toast.deactivatedDesc": "is no longer shown to clients.",
    "admin.wizards.toast.updateFailed": "Update failed",
    "admin.wizards.toast.couldNotUpdate": "Could not update wizard status.",
    "admin.wizards.areaOption.cr": "Company Registration",
    "admin.wizards.areaOption.pr": "Private Registration",
    "admin.wizards.modal.createTitle": "Create Wizard Steps",
    "admin.wizards.modal.editTitle": "Edit Wizard",
    "admin.wizards.modal.step1Desc": "Name your wizard and pick the service it belongs to.",
    "admin.wizards.modal.step2Desc": "Add and order form steps for this wizard.",
    "admin.wizards.modal.wizardNameEn": "Wizard Name (English)",
    "admin.wizards.modal.wizardNameAr": "اسم المعالج (بالعربية)",
    "admin.wizards.modal.wizardNamePlaceholderEn": "e.g. Commercial registration application",
    "admin.wizards.modal.wizardNamePlaceholderAr": "مثال: طلب تسجيل شركة تجارية",
    "admin.wizards.modal.nameRequiredEn": "English wizard name is required.",
    "admin.wizards.modal.nameRequiredAr": "اسم المعالج بالعربية مطلوب.",
    "admin.wizards.modal.service": "Service",
    "admin.wizards.modal.serviceSub": "One wizard per service — CR and PR each have their own live form.",
    "admin.wizards.modal.selectService": "Select service",
    "admin.wizards.modal.selected": "Selected",
    "admin.wizards.modal.selectServiceError": "Please select CR or PR.",
    "admin.wizards.modal.addFieldsPreview": "Add fields to see a preview of the client form.",
    "admin.wizards.modal.next": "Next",
    "admin.wizards.modal.back": "Back",
    "admin.wizards.modal.createWizard": "Create Wizard",
    "admin.wizards.modal.creating": "Creating…",
    "admin.wizards.modal.saveChanges": "Save Changes",
    "admin.wizards.modal.saving": "Saving…",
    "admin.wizards.modal.editForm": "Edit Form",
    "admin.wizards.modal.formLabel": "Form",
    "admin.applications.toast.notFoundTitle": "Application not found",
    "admin.applications.toast.answersSavedTitle": "Answers saved",
    "admin.applications.toast.saveFailedTitle": "Save failed",
    "admin.applications.toast.statusUpdatedTitle": "Status updated",
    "admin.applications.toast.updateFailedTitle": "Update failed",
    "admin.applications.toast.noteSavedTitle": "Note saved — visible to client",
    "admin.applications.toast.selectFormTitle": "Select a form",
    "admin.applications.toast.nextStepAddedTitle": "Next step added",
    "admin.applications.toast.addStepFailedTitle": "Failed to add step",
    "admin.applications.toast.noChangeTitle": "No change",
    "admin.applications.toast.noChangeDesc": "Application already has this status",
    "admin.applications.toast.notifiedSuccess": "Client notified successfully",
    "admin.applications.toast.statusSaved": "Application status saved",
    "client.applications.backToList": "Back to list",
    ...
    "client.applications.toast.noAppDesc": "There is no active form for {label} yet. Please check back later.",
    "client.applications.toast.openingDraftTitle": "Opening existing draft",
    "client.applications.toast.openingDraftDesc": "You already have an unfinished {label} application — continuing that one.",
    "client.applications.toast.couldNotOpenTitle": "Could not open application",
    "client.applications.toast.stepApprovedTitle": "Step approved",
    "client.applications.toast.stepApprovedDesc": "The next step is now open. You can continue filling the form.",
    "client.applications.toast.notFoundTitle": "Application not found",
    "client.applications.toast.stepLockedTitle": "Step locked",
    "client.applications.toast.completeEarlierDesc": "Complete earlier steps first.",
    "client.applications.toast.noFurtherTitle": "No further steps",
    "client.applications.toast.noFurtherDesc": "Please wait for an administrator to complete this step, or go back to earlier steps.",
    "client.applications.toast.saveFailedTitle": "Save failed",
    "client.applications.toast.savedTitle": "Saved",
    "client.applications.toast.applicationSubmittedTitle": "Application submitted",
    "client.applications.toast.submittedForReviewDesc": "Submitted for admin review. The team will examine your responses.",
    "client.applications.toast.submittedDesc": "Your application has been received.",
    "client.applications.viewDetails": "View Details",
    "client.fill.steps": "Steps",
    "client.fill.stepsSub": "Forms in order — {filled} of {total} completed",
    "client.fill.status": "Status",
    "client.fill.saveAsDraft": "Save as Draft",
    "client.fill.saveAndContinue": "Save & continue",
    "client.fill.submitApplication": "Submit application",
    "client.fill.saveForAdminReview": "Save for admin review",
    "client.fill.adminReview": "Admin review",
    "client.fill.completeApprovalsToSubmit": "Complete approvals to submit",
    "client.fill.stepOf": "Step {step} of {total}",
    "client.fill.stepsFilled": "{completed}/{total} steps filled",
    "client.fill.updated": "Updated",
    "client.fill.payment": "Payment",
    "client.fill.adminOnly": "Admin only",
    "client.fill.locked": "Locked",
    "client.fill.adminNote": "Note from admin",
    "client.fill.changesRequested": "Changes requested",
    "client.fill.continuingApp": "Continuing your application",
    "client.fill.startingApp": "Your application is starting",
    "client.fill.loadingDraft": "Loading your {area} draft…",
    "client.fill.preparingForms": "Preparing your {area} forms — one moment…",
    "client.fill.pendingApproval": "Pending approval from admin",
  ...
  ar: {
    ...
    "auth.userNotFound": "هذا البريد الإلكتروني غير مسجل",
    "auth.incorrectPassword": "اسم المستخدم أو كلمة المرور غير صحيحة",
    "auth.accountInactive": "الحساب غير نشط. يرجى التواصل مع المسؤول.",
    "auth.createClientAccount": "إنشاء حساب عميل",
    "auth.startJourney": "ابدأ رحلة تأسيس شركتك معنا",
    "auth.fullName": "الاسم الكامل",
    "auth.fullNameEn": "الاسم الكامل (بالإنجليزية)",
    "auth.fullNameAr": "الاسم بالعربية",
    "auth.fullNameArRequired": "الاسم بالعربية مطلوب.",
    "auth.fullNameEnPlaceholder": "مثال: John Doe",
    "auth.fullNameArPlaceholder": "مثال: جون دو",
    ...
    "auth.checkYourEmailDescription": "أرسلنا رابط التحقق إلى",
    "auth.checkSpamFolder": "لم يصلك البريد؟ تحقق من مجلد الرسائل غير المرغوب فيها، أو أعد إرسال رابط التحقق.",
    "auth.resendVerificationEmail": "إعادة إرسال بريد التحقق",
    "auth.resending": "جاري الإرسال...",
    "auth.verificationEmailResent": "تم إرسال بريد التحقق. يرجى التحقق من صندوق الوارد.",
    "auth.resendVerificationFailed": "فشل إعادة إرسال بريد التحقق.",
    "auth.emailRequiredForResend": "البريد الإلكتروني مطلوب لإعادة إرسال التحقق.",
    "auth.goToLogin": "الذهاب لتسجيل الدخول",
    "auth.emailNotVerified": "يرجى التحقق من بريدك الإلكتروني قبل تسجيل الدخول. تحقق من صندوق الوارد لرابط التحقق.",
    "auth.verifyingEmail": "جاري التحقق من البريد...",
    "auth.emailVerified": "تم التحقق من البريد",
    "auth.emailVerifiedSuccess": "تم التحقق من بريدك الإلكتروني. يمكنك الآن تسجيل الدخول.",
    "auth.verificationFailed": "فشل التحقق من البريد الإلكتروني.",
    ...
    "admin.sidebar.servicesCatalog": "دليل الخدمات",
    ...
    "admin.sidebar.paymentGateway": "بوابة الدفع",
    "admin.sidebar.aiChatbot": "الدردشة الذكية AI",
    "admin.sidebar.databaseConnection": "اتصال قاعدة البيانات",
    "admin.sidebar.notificationEvents": "أحداث الإشعارات",
    "admin.sidebar.backupRestore": "النسخ الاحتياطي والاستعادة",
    "admin.sidebar.audit": "السجلات التدقيقية",
    "admin.sidebar.auditLogs": "سجلات التدقيق",
    "admin.sidebar.userActivity": "نشاط المستخدمين",
    ...
    "admin.applications.searchPlaceholder": "البحث في الطلبات…",
    ...
    "admin.applications.card.total": "الإجمالي",
    "admin.applications.card.stepApprovalPending": "موافقة الخطوة معلقة",
    "admin.applications.card.submittedPending": "الطلبات المقدمة المعلقة",
    "admin.applications.card.clientInProgress": "العميل قيد التقدم",
    "admin.applications.heading": "الطلبات",
    "admin.applications.headingSub": "مراجعة المسودات، والطلبات المقدمة، وموافقات الخطوات.",
    "admin.applications.startForClient": "بدء طلب للعميل",
    "admin.applications.noMatch": "لا توجد طلبات تطابق بحثك.",
    "admin.applications.noApplicationsYet": "لا توجد طلبات معالج بعد.",
    "admin.applications.table.client": "العميل",
    "admin.applications.table.application": "الطلب",
    "admin.applications.table.service": "الخدمة",
    "admin.applications.table.steps": "الخطوات",
    "admin.applications.table.status": "الحالة",
    "admin.applications.table.stepApproval": "موافقة الخطوة",
    "admin.applications.table.updated": "تاريخ التحديث",
    "admin.applications.table.actions": "الإجراءات",
    "admin.applications.status.all": "جميع الحالات",
    "admin.applications.status.inProgress": "قيد التقدم",
    "admin.applications.status.pending": "معلق",
    "admin.applications.status.underReview": "قيد المراجعة",
    "admin.applications.status.hardCopyRequired": "مطلوب نسخة ورقية",
    ...
    "client.fill.loadingDraft": "جارٍ تحميل مسودة {area}…",
    "client.fill.preparingForms": "جارٍ تجهيز نماذج {area} — لحظة واحدة…",
    ...
    "admin.settings.general.clientNotifications": "إشعارات العميل",
    "admin.settings.general.clientNotificationsDesc": "تشغيل أو إيقاف إشعارات حالة الطلب للعملاء. البريد وواتساب يُتحكم بهما بشكل منفصل.",
    "admin.settings.general.emailNotifications": "إشعارات البريد الإلكتروني",
    "admin.settings.general.emailNotificationsDesc": "عند الإيقاف، لن يتم إرسال رسائل حالة الطلب إلى العملاء عبر البريد.",
    "admin.settings.general.whatsappNotifications": "إشعارات واتساب",
    "admin.settings.general.whatsappNotificationsDesc": "عند الإيقاف، لن يتم إرسال رسائل حالة الطلب إلى العملاء عبر واتساب.",
    "admin.settings.general.saved": "تم حفظ إعدادات إشعارات العميل.",
    "admin.settings.general.saveFailed": "فشل حفظ الإعدادات",
    "admin.settings.general.loadFailed": "فشل تحميل الإعدادات العامة",
    ...
    "client.sidebar.allApplications": "الطلبات",
    ...
    "client.sidebar.myInvoices": "فواتيري",
    ...
    "client.collaboration.addTitle": "إضافة متعاون",
    "client.collaboration.addDescription": "أرسل دعوة عبر البريد. واتساب اختياري إذا أضفت رقم الهاتف.",
    "client.collaboration.sendInvite": "إرسال الدعوة",
    "client.collaboration.whatsappOptional": "رقم واتساب (اختياري)",
    "client.collaboration.listTitle": "المتعاونون والدعوات",
    "client.collaboration.empty": "لا يوجد متعاونون بعد. ادعُ شخصًا للبدء.",
    "client.collaboration.status": "الحالة",
    "client.collaboration.invitedAt": "تاريخ الدعوة",
    "client.collaboration.actions": "إجراءات",
    "client.collaboration.oneClientNote": "يمكن ربط المتعاون بحساب عميل واحد فقط. بعد قبول الدعوة يمكنه بدء وتعبئة الطلبات نيابةً عنك.",
    "client.collaboration.loadFailed": "تعذر تحميل المتعاونين",
    "client.collaboration.inviteSent": "تم إرسال الدعوة",
    "client.collaboration.inviteSentDesc": "سيستلم المتعاون بريدًا يحتوي على رابط القبول.",
    "client.collaboration.inviteCreated": "تم حفظ الدعوة",
    "client.collaboration.emailSendFailed": "تم إنشاء الدعوة لكن تعذر إرسال البريد. تحقق من إعدادات البريد وأعد الإرسال.",
    "client.collaboration.inviteFailed": "فشل إرسال الدعوة",
    "client.collaboration.inviteResent": "أُعيد إرسال الدعوة",
    "client.collaboration.resendFailed": "فشل إعادة الإرسال",
    ...
    "client.applications.pageTitle": "الطلبات",
    "client.applications.pageDescription": "ابدأ طلباً جديداً أو تابع الطلبات التي قدمتها بالفعل",
    "client.applications.newTab": "طلب جديد",
    "client.applications.appliedTab": "الطلبات المقدمة",
    "client.applications.newCardTitle": "ابدأ طلباً جديداً",
    "client.applications.newCardDescription": "اختر مجال اهتمامك — سنفتح معالج الطلب النشط لهذه الخدمة فوراً.",
    "client.applications.draftBadge": "مسودة قيد التقدم",
    "client.applications.continueDraft": "متابعة المسودة",
    "client.applications.loading": "جارٍ التحميل…",
    "client.applications.noResults": "لا توجد نتائج",
    "client.applications.noApplicationsYet": "لا توجد طلبات بعد",
    "client.applications.applicationCountSingular": "طلب",
    "client.applications.applicationCountPlural": "طلبات",
    "client.applications.foundSuffix": "موجود",
    "client.applications.trackStatus": "تابع الحالة وواصل المسودات في أي وقت.",
    "client.applications.searchPlaceholder": "البحث في الطلبات…",
    "client.applications.emptyStateMessage": "لا توجد طلبات بعد. ابدأ واحدة من تبويب الطلب الجديد.",
    "client.applications.startNewApplication": "بدء طلب جديد",
    "client.applications.noSearchResults": "لا توجد طلبات تطابق بحثك.",
    "client.applications.continueApplication": "متابعة الطلب",
    "client.applications.viewApplication": "عرض الطلب",
    "client.applications.previousPage": "الصفحة السابقة",
    "client.applications.nextPage": "الصفحة التالية",
    "client.applications.pageLabel": "الصفحة {page}",
    "client.applications.status.draft": "مسودة",
    "client.applications.status.pending": "قيد الانتظار",
    "client.applications.status.inProgress": "قيد المعالجة",
    "client.applications.status.hardCopyRequired": "مطلوب نسخة ورقية",
    "client.applications.status.approved": "مقبول",
    "client.applications.status.rejected": "مرفوض",
    "client.applications.status.completed": "مكتمل",
    "client.applications.table.application": "الطلب",
    "client.applications.table.area": "المجال",
    "client.applications.table.progress": "التقدم",
    "client.applications.table.status": "الحالة",
    "client.applications.table.adminUpdate": "تحديث الإدارة",
    "client.applications.table.updated": "آخر تحديث",
    "client.applications.table.actions": "الإجراءات",
    "client.applications.table.stepSingular": "خطوة",
    "client.applications.table.stepPlural": "خطوات",
    "client.applications.table.pageOf": "الصفحة {page} من {totalPages}",
    "client.applications.table.record": "سجل",
    "client.applications.table.records": "سجلات",
    "client.applications.area.cr.label": "تسجيل الشركة (CR)",
    "client.applications.area.cr.description": "إنشاء شركة ذات مسؤولية محدودة في السعودية",
    "client.applications.area.pr.label": "تسجيل خاص (PR)",
    "client.applications.area.pr.description": "للمستثمرين والمواهب والرياديين وغيرهم",
    "admin.wizards.title": "إنشاء معالج الطلبات",
    "admin.wizards.heading": "معالجات التقديم",
    "admin.wizards.description": "معالج نشط واحد لكل خدمة — يمكن لكل من تسجيل الشركات والتسجيل الخاص الحصول على نموذج نشط خاص به.",
    "admin.wizards.loading": "جارٍ التحميل…",
    "admin.wizards.noResults": "لا توجد نتائج",
    "admin.wizards.noWizards": "لا توجد معالجات بعد",
    "admin.wizards.foundSuffix": "موجود",
    "admin.wizards.searchPlaceholder": "البحث في المعالجات…",
    "admin.wizards.createFirst": "أنشئ أول معالج لخطوات الطلب.",
    "admin.wizards.createButton": "إنشاء طلب",
    "admin.wizards.createStepsButton": "إنشاء خطوات الطلب",
    "admin.wizards.noMatch": "لا توجد معالجات تطابق بحثك.",
    "admin.wizards.table.name": "الاسم",
    "admin.wizards.table.service": "الخدمة",
    "admin.wizards.table.steps": "الخطوات",
    "admin.wizards.table.status": "الحالة",
    "admin.wizards.table.created": "تاريخ الإنشاء",
    "admin.wizards.table.actions": "الإجراءات",
    "admin.wizards.live": "مباشر",
    "admin.wizards.active": "نشط",
    "admin.wizards.inactive": "غير نشط",
    "admin.wizards.editLabel": "تعديل المعالج",
    "admin.wizards.deleteLabel": "حذف المعالج",
    "admin.wizards.previewLabel": "معاينة المعالج",
    "admin.wizards.stepSingular": "خطوة",
    "admin.wizards.stepPlural": "خطوات",
    "admin.wizards.recordSingular": "سجل",
    "admin.wizards.recordPlural": "سجلات",
    "admin.wizards.pageOf": "الصفحة {page} من {totalPages}",
    "admin.wizards.previousPage": "الصفحة السابقة",
    "admin.wizards.nextPage": "الصفحة التالية",
    "admin.wizards.pageLabel": "الصفحة {page}",
    "admin.wizards.dialog.switchTitle": "تبديل المعالج المباشر؟",
    "admin.wizards.dialog.switchDesc": "يمكن لمعالج واحد فقط أن يكون مباشراً للعملاء في نفس الوقت (تسجيل الشركات أو التسجيل الخاص). تفعيل",
    "admin.wizards.dialog.willDeactivate": "سيؤدي إلى تعطيل",
    "admin.wizards.dialog.cancel": "إلغاء",
    "admin.wizards.dialog.activate": "تفعيل المعالج",
    "admin.wizards.dialog.activating": "جارٍ التفعيل…",
    "admin.wizards.dialog.deleteTitle": "حذف المعالج؟",
    "admin.wizards.dialog.deleteDesc": "سيؤدي هذا إلى إزالة",
    "admin.wizards.dialog.cannotUndo": "لا يمكن التراجع عن هذا الإجراء.",
    "admin.wizards.dialog.delete": "حذف",
    "admin.wizards.dialog.deleting": "جارٍ الحذف…",
    "admin.wizards.toast.deleted": "تم حذف المعالج",
    "admin.wizards.toast.deletedDesc": "تمت الإزالة بنجاح.",
    "admin.wizards.toast.deleteFailed": "فشل الحذف",
    "admin.wizards.toast.couldNotDelete": "تعذر حذف المعالج.",
    "admin.wizards.toast.activated": "تم تفعيل المعالج",
    "admin.wizards.toast.activatedDesc": "أصبح متاحاً الآن لـ",
    "admin.wizards.toast.othersDeactivated": "المعالجات الأخرى",
    "admin.wizards.toast.deactivated": "تم تعطيل المعالج",
    "admin.wizards.toast.deactivatedDesc": "لم يعد يعرض للعملاء.",
    "admin.wizards.toast.updateFailed": "فشل التحديث",
    "admin.wizards.toast.couldNotUpdate": "تعذر تحديث حالة المعالج.",
    "admin.wizards.areaOption.cr": "تسجيل الشركة",
    "admin.wizards.areaOption.pr": "تسجيل خاص",
    "admin.wizards.modal.createTitle": "إنشاء خطوات المعالج",
    "admin.wizards.modal.editTitle": "تعديل المعالج",
    "admin.wizards.modal.step1Desc": "قم بتسمية المعالج واختيار الخدمة التي ينتمي إليها.",
    "admin.wizards.modal.step2Desc": "أضف ورتب خطوات النموذج لهذا المعالج.",
    "admin.wizards.modal.wizardNameEn": "اسم المعالج (بالإنجليزية)",
    "admin.wizards.modal.wizardNameAr": "اسم المعالج (بالعربية)",
    "admin.wizards.modal.wizardNamePlaceholderEn": "مثال: Commercial registration application",
    "admin.wizards.modal.wizardNamePlaceholderAr": "مثال: طلب تسجيل شركة تجارية",
    "admin.wizards.modal.nameRequiredEn": "اسم المعالج بالإنجليزية مطلوب.",
    "admin.wizards.modal.nameRequiredAr": "اسم المعالج بالعربية مطلوب.",
    "admin.wizards.modal.service": "الخدمة",
    "admin.wizards.modal.serviceSub": "معالج واحد لكل خدمة — يمكن لكل من تسجيل الشركات والتسجيل الخاص الحصول على نموذج نشط خاص به.",
    "admin.wizards.modal.selectService": "اختر الخدمة",
    "admin.wizards.modal.selected": "محدد",
    "admin.wizards.modal.selectServiceError": "يرجى اختيار تسجيل الشركات أو التسجيل الخاص.",
    "admin.wizards.modal.addFieldsPreview": "أضف حقولاً لرؤية معاينة نموذج العميل.",
    "admin.wizards.modal.next": "التالي",
    "admin.wizards.modal.back": "السابق",
    "admin.wizards.modal.createWizard": "إنشاء المعالج",
    "admin.wizards.modal.creating": "جارٍ الإنشاء…",
    "admin.wizards.modal.saveChanges": "حفظ التغييرات",
    "admin.wizards.modal.saving": "جارٍ الحفظ…",
    "admin.wizards.modal.editForm": "تعديل النموذج",
    "admin.wizards.modal.formLabel": "النموذج",
    "admin.applications.toast.notFoundTitle": "الطلب غير موجود",
    "admin.applications.toast.answersSavedTitle": "تم حفظ الإجابات",
    "admin.applications.toast.saveFailedTitle": "فشل الحفظ",
    "admin.applications.toast.statusUpdatedTitle": "تم تحديث الحالة",
    "admin.applications.toast.updateFailedTitle": "فشل التحديث",
    "admin.applications.toast.noteSavedTitle": "تم حفظ الملاحظة — مرئية للعميل",
    "admin.applications.toast.selectFormTitle": "اختر نموذجاً",
    "admin.applications.toast.nextStepAddedTitle": "تمت إضافية الخطوة التالية",
    "admin.applications.toast.addStepFailedTitle": "فشل إضافة الخطوة",
    "admin.applications.toast.noChangeTitle": "لا يوجد تغيير",
    "admin.applications.toast.noChangeDesc": "الطلب يمتلك هذه الحالة بالفعل",
    "admin.applications.toast.notifiedSuccess": "تم إشعار العميل بنجاح",
    "admin.applications.toast.statusSaved": "تم حفظ حالة الطلب",
    "client.applications.backToList": "الرجوع للقائمة",
    ...
    "client.applications.toast.couldNotLoadTitle": "تعذر تحميل الطلبات",
    "client.applications.toast.couldNotLoadDesc": "يرجى تسجيل الدخول كعميل والمحاولة مرة أخرى.",
    "client.applications.toast.noAppTitle": "لا يوجد طلب متاح",
    "client.applications.toast.noAppDesc": "لا يوجد نموذج نشط لـ {label} حتى الآن. يرجى التحقق لاحقاً.",
    "client.applications.toast.openingDraftTitle": "فتح المسودة الحالية",
    "client.applications.toast.openingDraftDesc": "لديك بالفعل طلب {label} غير مكتمل — جاري متابعته.",
    "client.applications.toast.couldNotOpenTitle": "تعذر فتح الطلب",
    "client.applications.toast.stepApprovedTitle": "تمت الموافقة على الخطوة",
    "client.applications.toast.stepApprovedDesc": "الخطوة التالية مفتوحة الآن. يمكنك الاستمرار في تعبئة النموذج.",
    "client.applications.toast.notFoundTitle": "الطلب غير موجود",
    "client.applications.toast.stepLockedTitle": "الخطوة مغلقة",
    "client.applications.toast.completeEarlierDesc": "أكمل الخطوات السابقة أولاً.",
    "client.applications.toast.noFurtherTitle": "لا توجد خطوات إضافية",
    "client.applications.toast.noFurtherDesc": "يرجى الانتظار حتى يقوم المسؤول بإكمال هذه الخطوة، أو العودة إلى الخطوات السابقة.",
    "client.applications.toast.saveFailedTitle": "فشل الحفظ",
    "client.applications.toast.savedTitle": "تم الحفظ",
    "client.applications.toast.applicationSubmittedTitle": "تم إرسال الطلب",
    "client.applications.toast.submittedForReviewDesc": "تم الإرسال لمراجعة الإدارة. سيقوم الفريق بفحص إجاباتك.",
    "client.applications.toast.submittedDesc": "تم استلام طلبك بنجاح.",
    ...
    "client.fill.steps": "الخطوات",
    "client.fill.stepsSub": "النماذج بالترتيب — مكتمل {filled} من {total}",
    "client.fill.status": "الحالة",
    "client.fill.saveAsDraft": "حفظ كمسودة",
    "client.fill.saveAndContinue": "حفظ ومتابعة",
    "client.fill.submitApplication": "إرسال الطلب",
    "client.fill.saveForAdminReview": "حفظ لمراجعة الإدارة",
    "client.fill.adminReview": "مراجعة الإدارة",
    "client.fill.completeApprovalsToSubmit": "استكمل الموافقات للإرسال",
    "client.fill.stepOf": "الخطوة {step} من {total}",
    "client.fill.stepsFilled": "تم تعبئة {completed} من {total} خطوات",
    "client.fill.updated": "تم التحديث",
    "client.fill.payment": "الدفع",
